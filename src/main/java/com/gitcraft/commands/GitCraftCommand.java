...
import com.gitcraft.commands.sub.ExportSubcommand;
...
public final class GitCraftCommand implements CommandExecutor, TabCompleter {
    ...
    public GitCraftCommand(GitCraft plugin, SelectionManager manager, SchematicExporter exporter) {
        ...
        subs.put("export", new ExportSubcommand(plugin, manager, exporter));
    }
